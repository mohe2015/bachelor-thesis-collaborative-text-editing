...
<intuitive-reason-for-avoiding-interleaving>
Consecutive insertions as shown in and reverse consecutive insertions as shown in create a single long branch in the Fugue tree. The intuitive reason this avoids interleaving in these cases is that merging concurrent edits never changes anything within concurrently created trees #cite(<2023-weidner-minimizing-interleaving>)[Section 4];.
